...
public class AddDialogFragment extends DialogFragment {
            ...
            public void onShow(DialogInterface dialog) {
                ...
                positiveButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        EditText editTextSupplier = addView.findViewById(R.id.supplier);
                        EditText editTextPhone = addView.findViewById(R.id.phone);
                        ...
                        if (TextUtils.isEmpty(name)  || TextUtils.isEmpty(quantityString) || TextUtils.isEmpty(priceString ) || TextUtils.isEmpty(supplier)  || TextUtils.isEmpty(phone)){
                            ...
                            insertProduct(name, quantity, price ,supplier , phone, mImageURI);
    ...
    private void insertProduct(String name, Integer quantity, Float price,String supplier,String phone, String imagePath) {
